...
type Server struct {
	...
	ShutdownTimeout time.Duration `env:"SERVER_SHUTDOWN_TIMEOUT" env-default:"10s"`
}
...
type Postgres struct {
	...
	MaxIdleConns    int           `env:"POSTGRES_MAX_IDLE_CONNS" env-default:"25"`
	ConnMaxLifetime time.Duration `env:"POSTGRES_MAX_LIFETIME"   env-default:"5m"`
	ConnMaxIdleTime time.Duration `env:"POSTGRES_MAX_IDLE_TIME"  env-default:"1m"`
}
